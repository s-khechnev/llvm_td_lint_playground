  ...
  let llvm_info =
    ...
    InstrTable.add ans (RV32, "aes32dsi") { mnemonic="aes32dsi"; arch=RV32; operands=["rd"; "rs1"; "rs2"; "bs"]; ins=[GPR "rs1"; GPR "rs2"; Imm "bs"]; outs=[GPR "rd"]; mayLoad=false; mayStore=false; ins_csr=[]; outs_csr=[] };
    InstrTable.add ans (RV32, "aes32dsmi") { mnemonic="aes32dsmi"; arch=RV32; operands=["rd"; "rs1"; "rs2"; "bs"]; ins=[GPR "rs1"; GPR "rs2"; Imm "bs"]; outs=[GPR "rd"]; mayLoad=false; mayStore=false; ins_csr=[]; outs_csr=[] };
    InstrTable.add ans (RV32, "aes32esi") { mnemonic="aes32esi"; arch=RV32; operands=["rd"; "rs1"; "rs2"; "bs"]; ins=[GPR "rs1"; GPR "rs2"; Imm "bs"]; outs=[GPR "rd"]; mayLoad=false; mayStore=false; ins_csr=[]; outs_csr=[] };
