...
(* generated by Ott 0.33 from: ../../language/sail.ott *)
(* open Lem_pervasives *)
...
let position_to_yojson : position -> Yojson.Safe.t = fun _ -> `String ""

let position_of_yojson : Yojson.Safe.t -> (position, _) Result.t =
 fun _ -> Result.Ok Lexing.dummy_pos
...
type bit = Sail_lib.bit = B0 | B1 [@@deriving yojson]
...
type loop = Ast.loop = While | Until [@@deriving yojson]
type 'a annot = l * 'a [@@deriving yojson]
...
type 'a clause_annot = def_annot * 'a [@@deriving yojson]
type x = string (* identifier *) [@@deriving yojson]
type ix = string (* infix identifier *) [@@deriving yojson]
...
type kid = Ast.kid = Kid_aux of kid_aux * l [@@deriving yojson]
type kind = Ast.kind = K_aux of kind_aux * l [@@deriving yojson]
type id = Ast.id = Id_aux of id_aux * l [@@deriving yojson]
...
and nexp = Ast.nexp = Nexp_aux of nexp_aux * l [@@deriving yojson]
...
type order_aux = Ast.order_aux =
  ...
  | Ord_inc (* increasing *)
  | Ord_dec
(* decreasing *) [@@deriving yojson]

type lit = Ast.lit = L_aux of lit_aux * l [@@deriving yojson]
...
and typ_pat = Ast.typ_pat = TP_aux of typ_pat_aux * l [@@deriving yojson]
...
(* constraint *) [@@deriving yojson]

type order = Ast.order = Ord_aux of order_aux * l [@@deriving yojson]
...
and 'a pat = 'a Ast.pat = P_aux of 'a pat_aux * 'a annot [@@deriving yojson]
...
type 'a pexp_funcl = 'a pexp [@@deriving yojson]
...
type subst_aux = Ast.subst_aux =
  ...
  | IS_id of id * id
(* instantiate an identifier with another identifier *) [@@deriving yojson]
...
type 'a scattered_def_aux = 'a Ast.scattered_def_aux =
  ...
  | SD_enumcl of id * id
  | SD_end of id
(* scattered definition end *) [@@deriving yojson]
...
type subst = Ast.subst = IS_aux of subst_aux * l [@@deriving yojson]
...
type prec = Ast.prec = Infix | InfixL | InfixR [@@deriving yojson]
